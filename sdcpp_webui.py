...
from modules.ui_txt2img import txt2img_block, pprompt_txt2img, nprompt_txt2img, width_txt2img, height_txt2img
from modules.ui_img2img import img2img_block, pprompt_img2img, nprompt_img2img, width_img2img, height_img2img
from modules.ui_gallery import gallery_block, cpy_2_txt2img_btn, cpy_2_img2img_btn, pprompt_info, nprompt_info, width_info, height_info
...
def cpy_2_txt2img(pprompt_info, nprompt_info, width_info, height_info):
    return gr.Tabs(selected="txt2img"), pprompt_info, nprompt_info, width_info, height_info


def cpy_2_img2img(pprompt_info, nprompt_info, width_info, height_info):
    return gr.Tabs(selected="img2img"), pprompt_info, nprompt_info, width_info, height_info
...
def sdcpp_launch(
    ...
    with gr.Blocks(css="footer {visibility: hidden}", title="sd.cpp-webui", theme="default", js=dark_js) as sdcpp:
        ...
        cpy_2_txt2img_btn.click(
            ...
            outputs=[tabs, pprompt_txt2img, nprompt_txt2img, width_txt2img, height_txt2img]
        )
        cpy_2_img2img_btn.click(
            cpy_2_img2img,
            inputs=[pprompt_info, nprompt_info, width_info, height_info],
            outputs=[tabs, pprompt_img2img, nprompt_img2img, width_img2img, height_img2img]
        )
