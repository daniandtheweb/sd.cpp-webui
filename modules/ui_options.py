    ...
    with gr.Row():
        ...
        set_btn.click(
            ...
            inputs=[ckpt_model, ckpt_vae, unet_model, unet_vae,
                    clip_g, clip_l, clip_vision_h, t5xxl, umt5_xxl,
                    model_type, sampling, steps, scheduler, width, height,
                    predict, flash_attn, diffusion_conv_direct,
                    vae_conv_direct, ckpt_dir_txt, unet_dir_txt,
                    vae_dir_txt, clip_dir_txt,
